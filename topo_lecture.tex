...
\begin{excursion}[filtered colimits.]
    ...
    \begin{example}
        ...
        \[= \colim(H^i(\IR^n, \IR^n\setminus\set 0) \xrightarrow{\cong} H^i(\IR^n; \IR^n\setminus D_1^n) \xrightarrow{\cong} \dots \xrightarrow{\cong} Hî(\IR^n, \IR^n\setminus D_k^n) \xrightarrow{\cong} \dots)\]
