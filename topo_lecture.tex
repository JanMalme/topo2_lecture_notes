...
\[\bigodot \colon \Hom(A,R) \times \Hom(B,R) \to \Hom(A\otimes B, R)\]
by \((f\bigodot g)(a\otimes b) = f(A) \cdot g(b)\). This is additive in \(f\) and \(g\).
\[(f+f') \bigodot g = (f\bigodot g) + (f' \bigodot g)\]
and
\[(rf) \bigodot g = r \cdot (f\bigodot g) = f \bigodot (r\cdotg)\]
for all \(r \in R\).
...
\begin{proof}
    For \(A = \IZ\):
    \[\begin{tikzcd}
        \Hom(\IZ,R) \otimes_R \Hom(B,R) \ar[r, "\bigodot"] \ar[d, "\ev \otimes_R \Hom(B,R)"] & \Hom(\IZ\otimes B, R) \ar[d, "\cong \; \Hom(k,R)"]\\
    ...
    \[\begin{tikzcd}
        \Hom(A\oplus A*, R) \otimes_R \Hom(B,R) \ar[r, "\bigodot"] \ar[d, phantom, sloped, "\cong"]& \Hom((A\oplus A') \otimes B, R) \ar[d, phantom, sloped, "\cong"] \\
...
\begin{example}
    \begin{description}
        ...
        \[\begin{tikzcd}
            \Hom(A,R) \otimes \Hom(B,R) \ar[r, "\bigodot"] & \Hom(A\otimes B, R) \\
        ...
        \[\begin{tikzcd}
            \Hom(A,R) \otimes_R \Hom(B,R) \ar[r, "\bigodot"] \ar[d, phantom, sloped, "="] & \Hom(A\otimes B, R) \\
...
\[\bigoplus_{p+q = n} \Hom(C_ü,R) \otimes_R \Hom(D_q, R) \xrightarrow{\text{sum of } \bigoplus} \Hom(\bigoplus_{p+q = n} C_p \otimes D_q, R)\]
